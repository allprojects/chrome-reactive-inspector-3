...
\begin{table}[]
	...
	\begin{tabular}{lllllllllllll}
		...
		Spec 1           & N     & Y               & Y              & Y             & Y            & Y    & Y                & Y                        & Y          & Y                  & Y         & Y \\
		Spec 2           & Y     & Y               & Y              & Y             & Y            & Y    & Y                & Y                        & Y          & Y                  & Y         & Y \\
		Spec 3           & Y     & Y               & Y              & Y             & Y            & Y    & Y                & Y                        & Y          & Y                  & Y         & Y \\
		Spec 4           & Y     & Y               & Y              & Y             & Y            & Y    & Y                & Y                        & Y          & Y                  & Y         & Y \\
		Spec 5           & Y     & Y               & Y              & Y             & Y            & Y    & Y                & Y                        & Y          & Y                  & Y(2)      & Y \\
		Spec 6           & Y     & Y               & Y              & Y             & Y            & Y    & Y                & Y                        & Y          & Y                  & Y         & Y \\
		Spec 7           & N.A   & Y               & Y              & Y             & Y            & Y    & Y                & Y                        & Y          & N.A, Y             & Y         & Y \\
		Spec 8           & N.A.  & Y               & Y              & Y             & Y            & Y    & N                & N                        & Y          & Y                  & Y         & N \\
		Spec 9           & N,Y   & N,Y             & N,Y            & N,Y           & N,Y          & N,Y  & N,Y              & Y                        & N,Y (1)    & N*,Y               & Y         & Y
	\end{tabular}%
}
...
\begin{table}[]
	...
	\begin{tabular}{lllllllllllllll}
		...
		Spec 1            & Y            & Y             & Y           & Y              & Y                 & Y            & Y                & Y             & Y               & Y                  & Y             & Y             & Y                & N   \\
		Spec 2            & Y            & Y             & Y           & Y              & Y                 & Y            & Y                & Y             & Y               & Y                  & Y             & Y             & Y                & Y   \\
		Spec 3            & Y            & Y             & Y           & Y              & Y                 & Y            & Y                & Y             & Y               & Y                  & Y             & Y             & Y                & Y   \\
		Spec 4            & Y            & Y             & Y           & Y              & Y                 & Y            & Y                & Y             & Y               & Y                  & Y             & Y             & Y                & Y   \\
		Spec 5            & Y(2)         & Y             & Y           & Y              & Y                 & Y            & Y                & Y             & Y               & Y                  & Y             & Y             & Y                & Y   \\
		Spec 6            & Y            & Y             & Y           & Y              & Y                 & Y            & Y                & Y             & Y               & Y                  & Y             & Y             & Y                & Y   \\
		Spec 7            & Y            & Y             & Y           & Y              & Y                 & Y            & Y                & Y             & Y               & Y                  & Y             & Y             & Y                & Y   \\
		Spec 8            & Y            & Y             & N           & Y              & Y                 & Y            & Y                & Y             & N               & Y                  & Y             & Y             & Y                & N   \\
		Spec 9            & Y            & Y             & N,Y         & N,Y            & N,Y               & N,Y          & Y                & Y             & Y               & N,Y                & Y             & N,Y           & N,Y              & N,Y
	\end{tabular}%
}
...
\begin{table}[]
	...
	\begin{tabular}{llllllllllllllllll}
		...
		Spec 1 & Y         & N         & Y        & Y      & N.A       & Y                                 & Y                    & Y                 & Y               & Y               & Y            & Y         & Y                   & Y                & Y                 & Y       & Y \\
		Spec 2 & Y         & Y         & Y        & Y      & Y         & Y                                 & Y                    & Y                 & Y               & Y               & Y            & Y         & Y                   & Y                & Y                 & Y       & Y \\
		Spec 3 & Y         & Y         & Y        & Y      & Y         & Y                                 & Y                    & Y                 & Y               & Y               & Y            & Y         & Y                   & Y                & Y                 & Y       & Y \\
		Spec 4 & Y         & Y         & Y        & Y      & Y         & Y                                 & Y                    & Y                 & Y               & Y               & Y            & Y         & Y                   & Y                & Y                 & Y       & Y \\
		Spec 5 & Y         & Y         & Y        & Y      & Y (2)     & Y                                 & Y                    & Y                 & Y               & Y               & Y            & Y         & Y                   & Y                & Y                 & Y       & Y \\
		Spec 6 & Y         & Y         & Y        & Y      & Y         & Y                                 & Y                    & Y                 & Y               & Y               & Y            & Y         & Y                   & Y                & Y                 & Y       & Y \\
		Spec 7 & Y         & N.A       & Am       & N.A.,Y & N.A       & Y                                 & Am                   & Y                 & Y               & Y               & Y            & Y         & Y                   & Y                & Y                 & Y       & Y \\
		Spec 8 & Y         & N.A       & Am       & Y      & N.A       & N                                 & Am                   & Y                 & Y               & Y               & Y            & N         & Y                   & Y                & Y                 & Y       & Y \\
		Spec 9 & Y         & Y         & Y        & Y      & Y         & Y                                 & Y                    & Y                 & Y               & Y               & Y            & Y         & Y                   & Y                & Y                 & Y       & Y
	\end{tabular}%
}
